...
<div class="top">
	...
	<div id="logo">
		<!-- the logo -->
		<a title="Học lập trình website với PHP và MYSQL" href=""> <img
			alt="Học lập trình website với PHP và MYSQL"
			src="<?php echo public_url()?>/site/images/logo.png"
			style="width: 250px">
		</a>
	</div>
	<!-- End logo -->
	...
	<div class="cart" id="cart_expand">
		<a class="cart_link" href="gio-hang.html"> Giỏ hàng <span id="in_cart">0</span>
			sản phẩm
	...
	<div id="search">
		...
		<form action="tim-kiem.html" method="get">
			<input type="text" aria-haspopup="true" aria-autocomplete="list"
				...
				placeholder="Tìm kiếm sản phẩm..." value="" name="key-search"
