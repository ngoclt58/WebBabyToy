...
<div class="box-center">
	...
	<nav class="navbar navbar-default" style = "background-color:#DCDCDC;height:3px;">
        <div class="container-fluid" >
	       <div class="navbar-header" >
		      <a class="navbar-brand" style = "color:#2385c4 ;">Chi tiết sản phẩm</a>
	       </div>
        </div>
    </nav>
	<div class="box-content-center product">
		...
		<div class='product_view_content'>
			...
			<p class='option'>
				Danh mục: <a
					href="<?php echo base_url('product/catalog/'.$catalog->id)?>"
					title="<?php echo $catalog->name?>"> <b><?php echo $catalog->name?></b>
				</a>
			</p>
		...
		<center  style='height: 15px;float:left;margin-top:10px;'>
			...
			<span style = "margin-top:40px; " class='st_facebook_hcount' displayText='Facebook'></span> 
			<span style = "margin-bottom:20px;" class='st_fblike_hcount' displayText='Facebook Like'></span></br>
		   <span style = "margin-top:10px;" class='st_googleplus_hcount' displayText='Google +'></span>
			<span style = "margin-top:20px;" class='st_twitter_hcount' displayText='Tweet'></span> 
			<!-- AddThis Button END -->
		</center>
		<div class='clear' style='height: 10px'></div>
