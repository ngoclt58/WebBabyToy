<div class="box-content-center register">
	...
	<form enctype="multipart/form-data" action="" method="post"
		...
		<!--  <div class="form-row">
			<label class="form-label" for="param_name">Tên Đăng Nhập:<span class="req">*</span></label>
			<div class="form-item">
				<input type="text" value="" name="name" id="name" class="input form-control">
				<div class="clear"></div>
		...
		<div class="form-row">
			...
			<div class="form-item">
				<input type="text" value="" name="email" id="email" class="input form-control">
				<div class="clear"></div>
