<div class="box-content-center register">
	...
	<form enctype="multipart/form-data" action="" method="post"
		...
		<div class="form-row">
			...
			<div class="form-item">
				<input type="text" value="<?php echo set_value('email')?>" name="email" id="email" class="input form-control">
				<div class="clear"></div>
		...
		<div class="form-row">
			<label class="form-label" for="param_name">Tên đăng nhập:<span
				class="req">*</span></label>
			<div class="form-item">
				<input type="text" value="<?php echo set_value('name')?>" name="name" id="name" class="input form-control">
				<div class="clear"></div>
		...
		<div class="form-row">
			<label class="form-label" for="param_phone">Số điện thoại:<span
				class="req">*</span></label>
			<div class="form-item">
				<input type="text" value="<?php echo set_value('phone')?>" name="phone" id="phone" class="input form-control">
				<div class="clear"></div>
		...
		<div class="form-row">
			...
			<div class="form-item">
				<textarea name="address" id="address" class="input form-control"></textarea>
				<div class="clear"></div>
		...
		<div class="form-row">
			...
			<div class="form-item">
				<input type="submit" name="submit" value="Đăng ký" class="btn btn-danger">
			</div>
		</div>
	</form>
</div>