		...
		<table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
			...
			<thead>
				<tr>
					...
					<td style="width:120px;">Cách thức thanh toán</td>
					<td style="width:120px;">Lời nhắn</td>
			...
			<tbody class="list_item">
			     ...
			     <tr class="row_<?php echo $row->id?>">
					...
					<td class="option textC">
						 <a class="tipS" title="Chỉnh sửa" href="<?php echo admin_url('transaction/edit/'.$row->id)?>">
