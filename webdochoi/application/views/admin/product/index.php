		...
		<table width="100%" cellspacing="0" cellpadding="0" id="checkAll"
								...
								<tbody>
									...
									<tr>
										<td style="width: 40px;" class="label"><label for="filter_id">Mã
												số</label></td>
										<td class="item"><input type="text" style="width: 55px;"
										...
										<td style="width: 155px;" class="item"><input type="text"
											...
											value="<?php echo $this->input->get('name')?>" name="name"></td>

										<td style="width: 60px;" class="label"><label
				...
				<tr>
					<td colspan="6">
						<div class="list_action itemActions">
							<a url="<?php echo admin_url('product/delete_all')?>"
			...
			<tbody class="list_item">
			     ...
			     <tr class="row_<?php echo $row->id?>">
					<td><input type="checkbox" value="<?php echo $row->id?>"
						name="id[]"></td>
					...
					<td>
						<div class="image_thumb">
							...
							<div class="clear"></div>
						</div> <a target="_blank" title="" class="tipS" href=""> <b><?php echo $row->name?></b>
					</a>

						<div class="f11">
					  Đã bán: <?php echo $row->count_buy?>	| Xem: <?php echo $row->view?>					
					 </div>
					...
					<td class="option textC"><a title="Xem chi tiết sản phẩm"
