...
<div class="wrapper">
	...
	<form enctype="multipart/form-data" method="post"
		action="<?php echo admin_url('product/add')?>" id="form" class="form">
		<fieldset>
			<div class="widget">
				<div class="title">
					<img class="titleIcon"
				...
				<div class="tab_container">
					<div class="tab_content pd0" id="tab1" style="display: block;">
						...
						<div class="formRow">
							<label class="formLeft">Ảnh mô tả:</label>
							<div class="formRight">
								<div class="left">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span class="oneTwo"> <input type="text" _autocheck="true"
									...
									original-title="GiÃ¡ bÃ¡n sá»­ dá»¥ng Ä‘á»ƒ giao dá»‹ch">
						...
						<div class="formRow">
							...
							<div class="formRight">
								<span> <input type="text" class="format_number"
									...
									src="<?php echo public_url('admin')?>/crown/images/icons/notifications/information.png"
									style="margin-bottom: -8px" class="tipS"
									original-title="Sá»‘ tiá»�n giáº£m giáº£m giÃ¡">
